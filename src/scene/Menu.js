...
<div className="flex justify-center">
      ...
      {/* <div className="flex flex-wrap gap-[20px]"> */}
        <div className="flex flex-col max-w-[348px] rounded-lg">
          <img src="/egusi.png" alt="egusi" className="rounded-tr-lg rounded-tl-lg" />
          <div className="p-[16px] md:p-[20px] lg:p-[24px] bg-[#FFF]">
            <div className="mb-[32px] md:mb-[40px] lg:mb-[48px]">
              <h3 className="text-[18px] md:text-[20px] lg:text-[24px] text-black mb-[8px] font-bold">Pounded Yam</h3>
              <p className="text-[14px] md:text-[16px]">Pounded yam with hot soup of Egusi with ogufe</p>
            </div>
            ...
            <div className="flex justify-between items-center ">
              ...
              <button onClick={HandleModalOpen} className="py-[8px] px-[10px] md:py-[12px] md:px-[18px] flex-shrink-0 rounded-[24px] border border-[#CA5834] text-[#CA5834] cursor-pointer hover:text-white hover:bg-[#CA5834]">
                Add to cart
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col max-w-[348px] rounded-lg">
          <img src="/jollof.png" alt="egusi" className="rounded-tr-lg rounded-tl-lg" />
          <div className="p-[16px] md:p-[20px] lg:p-[24px] bg-[#FFF]">
            <div className="mb-[32px] md:mb-[40px] lg:mb-[48px]">
              <h3 className="text-[18px] md:text-[20px] lg:text-[24px] text-black mb-[8px] font-bold">Pounded Yam</h3>
              <p className="text-[14px] md:text-[16px]">Pounded yam with hot soup of Egusi with ogufe</p>
        ...
        <div className="flex flex-col max-w-[348px] rounded-lg">
          <img src="/sharwarma.png" alt="egusi" className="rounded-tr-lg rounded-tl-lg" />
          <div className="p-[16px] md:p-[20px] lg:p-[24px] bg-[#FFF]">
            <div className="mb-[32px] md:mb-[40px] lg:mb-[48px]">
              <h3 className="text-[18px] md:text-[20px] lg:text-[24px] text-black mb-[8px] font-bold">Pounded Yam</h3>
              <p className="text-[14px] md:text-[16px]">Pounded yam with hot soup of Egusi with ogufe</p>
